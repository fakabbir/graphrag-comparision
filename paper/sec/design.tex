...
deterministic, and \textbf{10 of the 60} question-by-architecture cells returned
different labels across their three attempts --- 5 for text-to-SQL, 3 for
GraphRAG, 2 for vector RAG. The most consequential single cell is text-to-SQL on
the featured multi-hop question, whose three attempts were a falsehood, a fail and
a refusal. A single-attempt benchmark that happened to draw the third would have
recorded a harmless abstention and missed the paper's most important finding
entirely.
