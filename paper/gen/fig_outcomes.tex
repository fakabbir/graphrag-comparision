...
\addplot[fill=okcol] coordinates {({Text-to-SQL},36) ({Vector RAG},9) ({GraphRAG},50)};
\addplot[fill=badcol] coordinates {({Text-to-SQL},6) ({Vector RAG},0) ({GraphRAG},0)};
\addplot[fill=warncol] coordinates {({Text-to-SQL},10) ({Vector RAG},12) ({GraphRAG},0)};
\addplot[fill=gray!45] coordinates {({Text-to-SQL},8) ({Vector RAG},39) ({GraphRAG},1)};
\addplot[fill=gray!20] coordinates {({Text-to-SQL},0) ({Vector RAG},0) ({GraphRAG},9)};
